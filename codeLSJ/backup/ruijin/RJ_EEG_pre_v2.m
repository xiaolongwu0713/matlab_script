...
address=strcat('/Volumes/Samsung_T5/data/ruijin/gonogo/RJ_preprocessing_data/P',num2str(pn));
if ~exist(address,'dir')
    mkdir(address);
end
%cd(address);

Folder=strcat('/Volumes/Samsung_T5/data/ruijin/gonogo/RJ_preprocessing_data/P',num2str(pn),'/preprocessing');
if ~exist(Folder,'dir')
    mkdir(Folder);
end
...
for session = 1:sessionNum
    ...
    strname=strcat('/Volumes/Samsung_T5/data/ruijin/gonogo/RJ_Raw_Data/P',num2str(pn),'/H',num2str(session),'.mat');
    load(strname, 'EEG');
    strname=strcat('/Volumes/Samsung_T5/data/ruijin/gonogo/RJ_Raw_Data/P',num2str(pn),'/inf',num2str(session),'.mat');
...
%%
strname = strcat('/Volumes/Samsung_T5/data/ruijin/gonogo/RJ_preprocessing_data/P',num2str(pn),'/preprocessing/preprocessingAll_v2.mat');
