function grp_plotbrainfunction(cortex,vcontribs, tala,ix)
%% Display options
...
viewstruct.what2view = {'brain','activations'};%input('Enter what2view: ');
param.electrodes_pos = 'left';%input('What side of the brain do you want to view? (''left'' | ''right''): ');
...
% placeToSaveFile = strcat(pathToSubjectDir, '.mat');
