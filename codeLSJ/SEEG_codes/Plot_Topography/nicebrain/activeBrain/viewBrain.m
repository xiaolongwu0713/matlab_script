function [ ] = viewBrain( M, subjstructs, what2view, transp, colix, viewvect    ,inx, opti_chn_set )
...
%          plotBalls(subjstructs.trielectrodes(opti_chn_set, :), 'red', 1.5);
%          hold on;
%          plotBalls(subjstructs.trielectrodes(setdiff(1:size(subjstructs.trielectrodes, 1), opti_chn_set), :),[0.1 0.1 0.1], 1.5); 
plotBalls(subjstructs.trielectrodes_good_channels_setdiff, [88/255 80/255 141/255], 1.5); 
hold on;
plotBalls(subjstructs.trielectrodes_optimal, [222/255 66/255 91/255], 2.5); 
