function varargout = plotcwt(varargin)
% PLOTCWT MATLAB code for plotcwt.fig
%      PLOTCWT, by itself, creates a new PLOTCWT or raises the existing
%      singleton*.
%
%      H = PLOTCWT returns the handle to a new PLOTCWT or the handle to
%      the existing singleton*.
%
%      PLOTCWT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PLOTCWT.M with the given input arguments.
%
%      PLOTCWT('Property','Value',...) creates a new PLOTCWT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before plotcwt_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to plotcwt_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help plotcwt

% Last Modified by GUIDE v2.5 05-Jan-2021 21:45:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @plotcwt_OpeningFcn, ...
                   'gui_OutputFcn',  @plotcwt_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before plotcwt is made visible.
function plotcwt_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to plotcwt (see VARARGIN)
...
% Choose default command line output for plotcwt
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes plotcwt wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = plotcwt_OutputFcn(hObject, eventdata, handles) 
